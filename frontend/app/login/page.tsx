...
export default function LoginPage() {
  ...
  const handleSSOLogin = (provider: string) => {
    // TODO: Implement SSO OAuth flows
    setError(`${provider} SSO not yet implemented. Contact your administrator.`)
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2">Welcome to AstralAI</h1>
          <p className="text-gray-600">Multi-Platform Marketing Automation</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full px-6 py-3 border-2 border-gray-300 rounded-lg font-medium hover:bg-gray-50 transition-all flex items-center justify-center gap-3"
            >
